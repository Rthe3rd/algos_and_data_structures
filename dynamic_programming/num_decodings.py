...
def numDecodings(digits):
    ...
    def dfs(start_index):
        ...
        # Similar to generate valid paranthesis, the get edges is made with if statements and conditionals
        if digits[start_index] == "0":
            return ways

        # ans = aggretation with updated parameters. Here we don't need to pass state
